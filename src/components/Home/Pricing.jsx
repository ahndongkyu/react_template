        ...
        {pricingOptions.map((option, idx) => (
          <div key={idx} className="p-2 w-full sm:w-1/2 lg:w-1/3">
            <div className="p-10 border border-neutral-700 rounded-lg">
              ...
              <Link
                to={option.link}
                className="flex justify-center items-center w-full py-2 border border-green-700 rounded-lg mt-20 font-customFontEn hover:bg-green-700 hover:text-white transition duration-300"
              >
                Subscribe
              </Link>
            </div>
